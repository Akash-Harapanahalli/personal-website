...
<style>
  ...
  .conferences ol > li::marker {
    content: "[C" counter(item) "]  ";
  }
  .conferences a {font-weight: bold;}
</style>
...
1. **Akash Harapanahalli**, Samuel Coogan, Alexander Davydov, "[Learning Certified Neural Network Controllers Using Contraction and Interval Analysis.](https://arxiv.org/abs/2603.28011)" In submission, 2026. \[[pdf](https://arxiv.org/pdf/2603.28011)\]
1. Varun Madabushi, **Akash Harapanahalli**, Samuel Coogan, Maegan Tucker, "[Differentiable Invariant Sets for Hybrid Limit Cycles with Application to Legged Robots.](https://arxiv.org/abs/2604.05108)" In submission, 2026. \[[pdf](https://arxiv.org/pdf/2604.05108)\]
1. **Akash Harapanahalli**, Samuel Coogan, "[Efficient Norm-Based Reachable Sets via Iterative Dynamic Programming.](https://arxiv.org/abs/2509.23367)" To appear in 2026 American Control Conference. \[[pdf](https://arxiv.org/pdf/2509.23367)\]
1. **Akash Harapanahalli**, Samuel Coogan, "[Certified Robust Invariant Polytope Training in Neural Controlled ODEs.](https://arxiv.org/abs/2408.01273)" To appear in 2026 Learning for Dynamics and Control Conference. \[[pdf](https://arxiv.org/pdf/2408.01273)\] \[[code](https://github.com/gtfactslab/Polytope-Training)\] \[[slides](/presentations/2025VNNCS_workshop/)\]
...
1. **Akash Harapanahalli**, Samuel Coogan, "[A Linear Differential Inclusion for Contraction Analysis to Known Trajectories.](https://doi.org/10.1109/TAC.2025.3626266)" Published in IEEE Transactions on Automatic Control (**TAC**), 2025. \[[pdf](https://arxiv.org/pdf/2411.11587)\] \[[slides](/presentations/2024CDC_LDIcontr/)\]
1. Brendan Gould, **Akash Harapanahalli**, Samuel Coogan "[Automatic and Scalable Safety Verification Using Interval Reachability With Subspace Sampling.](https://doi.org/10.1109/LCSYS.2025.3582206)", Published in IEEE Control Systems Letters (**L-CSS**), 2025. \[[pdf](https://coogan.ece.gatech.edu/papers/pdf/gould2025interval.pdf)\]
